...
//        legend.setDrawInside(false);
    ...
    private void initLineDataSet(LineDataSet lineDataSet, int color, boolean mode) {
        ...
        lineDataSet.setCircleColor(0xff0000ff);
...
//        lineDataSet.setMode(LineDataSet.Mode.CUBIC_BEZIER);
     ...
     * @param color
     */
    public void showLineChart(List<Float> xAxisValues, List<Float> yAxisValues, String label, int color, final Map<Float,String> map) {
        initLineChart();
        MyMarkerView mv = new MyMarkerView(context, R.layout.marker,map);
